function scoreFun(object, opts) {
  ...
  startParent.find("a").each(function(index, element) { $(this).click(function() { now_cli = index;
      show(index, $(this)) });
    ...
    $(this).mouseleave(function() {
      if (now_cli >= 0) {
        ...
        if (countScore) { countScore.text(scor) } } else { startParent.find("a").removeClass("clibg");
