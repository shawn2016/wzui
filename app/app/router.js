...
// button
 'page': {
    url: "/page",
    requireCtl:["page/main/headerCtrl","page/main/footerCtrl"],
    views: {
        "head": {
        templateUrl: "page/main/head.html",
        controller: "headerCtrl"
      },
        "view_centers": {
       ...
       "footer": {
        templateUrl: 'page/main/footer.html',
  ...
  'page.button': {
    url: '/button',
    templateUrl: 'page/button/button.html',
    requireCtl: 'page/button/buttonCtrl',
    controller: 'buttonCtrl'
  },
  'page.datetime-picker': {
    url: '/datetime-picker',
    templateUrl: 'page/datetime-picker/datetime-picker.html',
    requireCtl: 'page/datetime-picker/datetime-pickerCtrl',
    controller: 'datetime-pickerCtrl'
  },
 'page.bank-picker': {
    url: '/bank-picker',
    templateUrl: 'page/bank-picker/bank-picker.html',
    requireCtl: 'page/bank-picker/bank-pickerCtrl',
    controller: 'bank-pickerCtrl'
  },
 'page.area-picker': {
    url: '/area-picker',
    templateUrl: 'page/area-picker/area-picker.html',
    requireCtl: 'page/area-picker/area-pickerCtrl',
    controller: 'area-pickerCtrl'
  },
  /*==============起步============*/
  'start': {
    url: "/start",
  ...
  'components.button': {
    ...
    url: '/datetime-picker',
    templateUrl: 'modules/components/datetime-picker/datetime-picker.html',
    requireCtl: 'modules/components/datetime-picker/datetime-pickerCtrl',
    controller: 'datetime-pickerCtrl'
  },
    'components.bank-picker': {
    url: '/bank-picker',
    templateUrl: 'modules/components/bank-picker/bank-picker.html',
    requireCtl: 'modules/components/bank-picker/bank-pickerCtrl',
    controller: 'bank-pickerCtrl'
  },
    'components.area-picker': {
    url: '/area-picker',
    templateUrl: 'modules/components/area-picker/area-picker.html',
    requireCtl: 'modules/components/area-picker/area-pickerCtrl',
    controller: 'area-pickerCtrl'
  },
