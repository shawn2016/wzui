(function() {
    ...
    function IosSelect(level, data, options) {
        ...
        console.log(this.options.headerDirection)
    ...
    IosSelect.prototype = {
        ...
        initLayer: function() {
            var self = this;
            var all_html = [
                '<div style="height: ' + this.options.headerHeight + this.options.cssUnit + '; line-height: ' + this.options.headerHeight + this.options.cssUnit + '" class="iosselect-header">',
            ...
            if (this.options.headerHeight && this.options.itemHeight) {
                ...
                if (this.options.headerDirection === "bottom") {
                    this.coverArea1Dom.style.top = this.options.headerHeight - 44 + this.options.itemHeight * this.options.coverArea1Top + this.options.cssUnit;
                    this.coverArea2Dom.style.top = this.options.headerHeight - 44 + this.options.itemHeight * this.options.coverArea2Top + this.options.cssUnit;
                } else {
            ...
            if (this.options.headerDirection === "bottom") {
                this.iosselectHeaderDom = this.iosSelectLayer.el.querySelector('.iosselect-header');
                this.iosselectBoxDom = this.iosSelectLayer.el.querySelector('.iosselect-box');

                this.iosselectBoxDom.style.top = 0
                this.iosselectBoxDom.style.bottom = "auto"
                this.iosselectHeaderDom.style.top = "auto"
                this.iosselectHeaderDom.style.bottom = 0
            }
